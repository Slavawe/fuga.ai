...
pub use ai::{
    ...
    tm_generate::{tm_generate, tm_generate_beam, tm_generate_latent, tm_generate_latent_bytes, tm_generate_speculative, tm_generate_two_speed, tm_generate_two_speed_calib, tm_generate_two_speed_entropy},
    transpile::{
